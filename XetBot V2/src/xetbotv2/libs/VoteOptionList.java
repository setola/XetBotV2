...
class VoteOptionList {
  ...
  public VoteOptionList(int maxNumberOfElemnts){
  ...
  */
  public VoteOption[] getSorted(int by){
    switch(by){
      case VoteOptionList.SORT_ASCENDING:
        return sortAscending();
      //break;
      
      case VoteOptionList.SORT_DESCENDING:
  ...
  public static void main(String[] args){
    VoteOptionList asd = new VoteOptionList(3);
